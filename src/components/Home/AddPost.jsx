...
function AddPost() {
  ...
  const is_post_saving = useSelector((state)=> state._posts.is_post_saving);

  return (
    <section class="add-post-section-container">
      <div class="add-post-section-wrapper">
        <div class="add-post-section">
         
          <div class="add-post">
            <div class="add-post-profile-img">
              <img src={current_user?.photoURL}></img>
            </div>
            <div onClick={show_add_post_modal} class="add-post-text">
              <span> What's on Your Mind {current_user?.displayName}</span>
            </div>
            {is_post_saving && <Spinner/>}
          </div>
          <div class="separator"></div>
          <div class="add-media-section">
            <div class="add-media-item">
              <div class="live-video-icon media-icon">
                <svg
                  viewBox="0 0 24 24"
                  width="1em"
                  height="1em"
                  class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fxtw5amg i2fa72qc rgmg9uty b73ngqbp">
            ...
            <div class="add-media-item">
              <div class="photo-video-icon media-icon">
                <svg
                  viewBox="0 0 24 24"
                  width="1em"
                  height="1em"
            ...
            <div class="add-media-item">
              <div class="feeling-icon media-icon">
                <svg
                  viewBox="0 0 24 24"
                  width="1em"
                  height="1em"
                  class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 mu8pnim0 ky11obwa rgmg9uty b73ngqbp"
                >
                  <g fill-rule="evenodd" transform="translate(-444 -156)">
                    <g>
                      <path
