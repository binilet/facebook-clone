...
function Header() {
  ...
  const _user_object = useSelector((state) => state._current_user.user);
  console.log('from header----- ' + _user_object?.displayName);
  ...
  const _showUpdateProfilePicModal = ()=>{
    var modal = document.getElementById('update_profile_pic_container');
  ...
  //update_profile_pic_container
  return (
    <>
    <header class="header">
      <div class="left-header">
        <div class="logo-container">
          <img src="https://1000logos.net/wp-content/uploads/2016/11/Facebook-logo-500x350.png"></img>
        </div>
      ...
      <div class="center-header">
        <ul class="main-menu">
          <li class="main-menu-list-item collapsible">
            <div class="menu-item-wrapper">
              <div class="menu-item">
                <svg viewBox="0 0 28 28" height="28" width="28">
                  <path
                    d="M25.825 12.29C25.824 
          ...
          <li class="main-menu-list-item hamburger-menu">
            <div class="menu-item-wrapper">
              <div class="menu-item">
                <svg
                  viewBox="0 0 28 28"
                  class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 py1f6qlh em6zcovv"
                  height="28"
                  width="28"
                >
      ...
      <div class="right-header">
        <div class="right-header-container">
          <div class="header-user" onClick={_showUpdateProfilePicModal}>
            <div class="profile-img-header">
              <img src={_user_object?.photoURL} />
            </div>
            <span className="user_name">{_user_object?.displayName}</span>
          </div>
          ...
          <div class="right-header-menu">
            <svg viewBox="0 0 28 28" alt="" class="right-svgs">
          ...
          <div
            ...
            class="right-header-menu"
          >
            <i style={{backgroundImage: "url(https://static.xx.fbcdn.net/rsrc.php/v3/yi/r/QnBF2xVFFiX.png)", backgroundPosition:"0px -46px", backgroundSize:"auto", width:"20px", height: "20px", backgroundRepeat: "no-repeat", display:"inline-block"}}></i>
          </div>
        </div>
      </div>
